...
var stand,polygon,backgroundImg
var engine,world;
var ground,polygonImg,blackBg
var score=0

function preload(){
bg=loadImage("yellowBg.png")
...
function draw() {
  ...
  block38.display()
  block39.display()
  stand=new Ground(1000,378,10000,20);
  stand1=new Ground(1000,378,10000,20);
  stand2=new Ground(1000,378,10000,20);
  ball.display()
  spring.display()
  ground.display()
...
async function getBackgroundImg(){
  var response =await fetch ("http://worldtimeapi.org/timezone/America/Toronto")
  ...
  if(hour >=06&&hour<=18){
    bg="images/yellow.png"
  }else{
    bg="images/blackbackgroundImg";
